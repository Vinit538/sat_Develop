...
//                             <h5 className="card-title placeholder-glow">Expert Trainers</h5>
//                             <p className="card-text placeholder-glow">Learn from certified trainers with real-world experience and in-depth knowledge.</p>
//                         </div>
//                     </div>
//                 </div>
//                 <div className="col-md-4">
